import type { ClassDefinition, SkillDefinition } from '../types/game';
...
export const getClassById = (id: string) => CLASSES.find((entry) => entry.id === id);
export const getSkillById = (id: string) => SKILLS.find((entry) => entry.id === id);
