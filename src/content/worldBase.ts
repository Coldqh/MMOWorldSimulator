...
export const BASE_MOBS: MobDefinition[] = [
  ...
  { id: 'old_lantern_warden', name: 'Сторож Старого Фонаря', level: 5, stats: { hp: 135, mana: 25, attack: 16, magic: 6, defense: 7, speed: 5 }, xp: 110, gold: [28, 55], lootTableId: 'lt_old_lantern_dungeon', tags: ['boss', 'dungeon'] },
  { id: 'thorn_crown_hound', name: 'Пёс Терновой Короны', level: 7, stats: { hp: 170, mana: 20, attack: 21, magic: 4, defense: 8, speed: 9 }, xp: 145, gold: [40, 80], lootTableId: 'lt_old_lantern_dungeon', tags: ['boss', 'dungeon'] },
  { id: 'blackroot_sentinel', name: 'Часовой Чёрного Корня', level: 9, stats: { hp: 230, mana: 35, attack: 25, magic: 8, defense: 12, speed: 6 }, xp: 220, gold: [75, 135], lootTableId: 'lt_blackroot_raid', tags: ['boss', 'dungeon'] },
