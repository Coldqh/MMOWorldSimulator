...
const duplicateIds = (kind: string, ids: string[]): ContentValidationIssue[] => {
...
const has = (set: Set<string>, id?: string) => Boolean(id && set.has(id));

export const validateContent = (): ContentValidationIssue[] => {
  const issues: ContentValidationIssue[] = [];
