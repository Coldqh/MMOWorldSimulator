...
export const ROLE_FOCUSES: RoleFocus[] = [
  'PVE_FARMER', 'RAIDER', 'PVP_PLAYER', 'GUILD_PLAYER', 'COLLECTOR', 'TRADER', 'CASUAL', 'HARDCORE', 'LEADER', 'DRAMA'
];
...
export const GUILD_TEMPLATES: Array<{ name: string; type: GuildType; focus: string; recruitmentPolicy: Guild['recruitmentPolicy']; tier?: 'low' | 'mid' | 'high'; minLevel?: number }> = [
  { name: 'Silver Hares', type: 'CASUAL', focus: 'низкие уровни, чат, данжи', recruitmentPolicy: 'open', tier: 'low', minLevel: 1 },
  { name: 'First Camp', type: 'NEWBIE', focus: 'новички, группы, заявки', recruitmentPolicy: 'open', tier: 'low', minLevel: 1 },
  { name: 'Warm Ash', type: 'CASUAL', focus: 'вечерний фарм', recruitmentPolicy: 'open', tier: 'low', minLevel: 1 },
  { name: 'Blue Cartel', type: 'TRADE', focus: 'рынок, скупка, перепродажа', recruitmentPolicy: 'invite', tier: 'low', minLevel: 1 },
  ...
  { name: 'Mushroom Guard', type: 'CASUAL', focus: 'споты и помощь', recruitmentPolicy: 'open', tier: 'mid', minLevel: 10 },
  ...
  { name: 'Nevermore', type: 'HARDCORE', focus: 'рейдовый прогресс', recruitmentPolicy: 'strict', tier: 'high', minLevel: 20 },
  { name: 'Jotunheim', type: 'PVP', focus: 'топ арены', recruitmentPolicy: 'strict', tier: 'high', minLevel: 20 },
  { name: 'Triumvirate', type: 'HARDCORE', focus: 'рейды и топ Gear Score', recruitmentPolicy: 'strict', tier: 'high', minLevel: 20 },
  ...
  { name: 'Alpha Leone', type: 'HARDCORE', focus: 'лучший шмот сервера', recruitmentPolicy: 'strict', tier: 'high', minLevel: 20 },
  { name: 'Dawn Vendor', type: 'TRADE', focus: 'рынок хай-лвл шмота', recruitmentPolicy: 'invite', tier: 'mid', minLevel: 10 },
  { name: 'Rusty Mug', type: 'CASUAL', focus: 'без гонки, вечерние пати', recruitmentPolicy: 'open', tier: 'low', minLevel: 1 },
