...
export const getQuestGiverById = (id) => QUEST_GIVERS.find((giver) => giver.id === id);
export const getQuestGiversByZoneId = (zoneId) => QUEST_GIVERS.filter((giver) => giver.zoneId === zoneId);
