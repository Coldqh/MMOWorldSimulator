export const SET_CLASSES = ['warrior', 'ranger', 'mage', 'priest'];
export const SET_SLOTS = ['weapon', 'head', 'chest', 'legs', 'boots', 'ring', 'amulet'];
export const GLASS_CATACOMB_SLOTS = ['weapon', 'chest', 'legs', 'ring', 'amulet'];
export const FIRST_WYRM_SHARED_SLOTS = ['head', 'chest', 'legs', 'boots', 'ring', 'amulet'];
...
export const GENERAL_SET_DEFINITIONS = [
...
export const DUNGEON_SET_DEFINITIONS = [
...
export const RAID_SET_DEFINITIONS = [
