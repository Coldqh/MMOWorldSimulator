...
assert(pkg.version === '0.7.51', 'package version is 0.7.51');
assert(versionTs.includes("APP_VERSION = '0.7.51'") || versionTs.includes('APP_VERSION = "0.7.51"'), 'APP_VERSION is 0.7.51');
assert(publicVersion.version === '0.7.51', 'public version is 0.7.51');
...
assert(sw.includes("mmows-v0.7.51"), 'service worker cache is 0.7.51');
