...
assert(pkg.version === '0.7.49', 'package version is 0.7.49');
assert(versionTs.includes("APP_VERSION = '0.7.49'") || versionTs.includes('APP_VERSION = "0.7.49"'), 'APP_VERSION is 0.7.49');
assert(publicVersion.version === '0.7.49', 'public version is 0.7.49');
...
assert(sw.includes("mmows-v0.7.49"), 'service worker cache is 0.7.49');
