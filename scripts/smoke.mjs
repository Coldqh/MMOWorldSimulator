...
assert(pkg.version === '0.7.43', 'package version is 0.7.43');
assert(versionTs.includes("APP_VERSION = '0.7.43'") || versionTs.includes('APP_VERSION = "0.7.43"'), 'APP_VERSION is 0.7.43');
assert(publicVersion.version === '0.7.43', 'public version is 0.7.43');
...
assert(sw.includes("mmows-v0.7.43"), 'service worker cache is 0.7.43');
