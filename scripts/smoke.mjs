...
assert(pkg.version === '0.7.48', 'package version is 0.7.48');
assert(versionTs.includes("APP_VERSION = '0.7.48'") || versionTs.includes('APP_VERSION = "0.7.48"'), 'APP_VERSION is 0.7.48');
assert(publicVersion.version === '0.7.48', 'public version is 0.7.48');
...
assert(sw.includes("mmows-v0.7.48"), 'service worker cache is 0.7.48');
