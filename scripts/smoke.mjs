...
assert(pkg.version === '0.7.45', 'package version is 0.7.45');
assert(versionTs.includes("APP_VERSION = '0.7.45'") || versionTs.includes('APP_VERSION = "0.7.45"'), 'APP_VERSION is 0.7.45');
assert(publicVersion.version === '0.7.45', 'public version is 0.7.45');
...
assert(sw.includes("mmows-v0.7.45"), 'service worker cache is 0.7.45');
