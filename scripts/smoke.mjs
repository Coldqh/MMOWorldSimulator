...
assert(pkg.version === '0.7.44', 'package version is 0.7.44');
assert(versionTs.includes("APP_VERSION = '0.7.44'") || versionTs.includes('APP_VERSION = "0.7.44"'), 'APP_VERSION is 0.7.44');
assert(publicVersion.version === '0.7.44', 'public version is 0.7.44');
...
assert(sw.includes("mmows-v0.7.44"), 'service worker cache is 0.7.44');
